            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text">
                        <h1><strong>Lukman</strong> Sensor</h1>
                        <div class="description">
                            <p>Daftar akun baru untuk mengakses layanan kami.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 form-box">
                        <div class="form-top">
                            <div class="form-top-left">
                                ...
                                <p>Isi formulir di bawah ini untuk membuat akun:</p>
                            </div>
                        ...
                        <div class="form-bottom">
                            <form role="form" action="register_process.php" method="post" class="register-form">
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 social-login">
                        <h3>Sudah punya akun? <strong><a href="index.html">Masuk</a></strong></h3>
                    </div>
                </div>
            </div>
        </div>
